...
<head>
  ...
  <!-- Servicios -->
  <script src="angular/servicios/configuracion_service.js" charset="utf-8"></script>
  <script src="angular/servicios/mensajes_service.js" charset="utf-8"></script>
  <script src="angular/servicios/notificaciones_service.js" charset="utf-8"></script>
  <script src="angular/servicios/clientes_service.js" charset="utf-8"></script>
</head>
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu"
            ng-include="'template/mensaje.html'">
          </li>
          <!-- /.messages-menu -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{ config.anio }} <a href="{{ config.web }}" target="_blank">Company</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
